...
#define MODNAME "mcp3421"
#define PREFIX "mcp3421"

MODULE_AUTHOR("Bosston88");
MODULE_DESCRIPTION("Driver for mcp3421 I2C");
MODULE_LICENSE("GPL");
...
int rtapi_app_main(void)
{
	...
	/* export the pin(s) */
	retval = hal_pin_float_newf(HAL_OUT, &(data->data_in), comp_id, "%s.voltage.out", prefix, n); //dodane n
	if (retval < 0) {
